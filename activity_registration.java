...
public class activity_registration extends AppCompatActivity {
    ...
    String url = "http://192.168.43.141/ibankdb/register.php";
        ...
        if(ed_username.getText().toString().equals("")){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.dismiss();
                    Toast.makeText(activity_registration.this, error.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(activity_registration.this);
