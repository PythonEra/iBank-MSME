...
public class CardPin extends AppCompatActivity {
    private static final String url = "http://192.168.43.141/ibankdb/generatepin.php";
    ...
    private void sendtdata()
    {
        ...
        final String  pin=s5.getText().toString().trim();
