...
public class CardLimit extends AppCompatActivity {

    private static final String url = "http://192.168.43.141/ibankdb/cardlimit.php";
    ...
    private void sendtdata()
    {
        ...
        final String cardno=s4.getText().toString().trim();
        final String  limit1=s5.getText().toString().trim();
